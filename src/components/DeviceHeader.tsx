        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5 flex items-center gap-3">
              <span>Target: <strong className="text-slate-800">{targetModel}</strong></span>
              <span>•</span>
              <span>Firmware: <span className="font-mono text-xs text-slate-600">{firmwareVersion}</span></span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            <p className="text-xs font-medium text-slate-500 flex items-center justify-end gap-1">
              ...
              Target IP: {ip || 'Not set'}
            </p>
            <p className="text-xs text-slate-400 font-mono">Port 8002 (WSS)</p>
          </div>
          {getStatusBadge()}
        </div>
      </div>
